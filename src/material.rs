...
pub fn get_material(board: &Board) -> u32 {
    ...
    let black_king = pieces::get_black_pieces(Piece::King, board) * 99999;
    ...
    let white_king = pieces::get_white_pieces(Piece::King, board) * 99999;
    ...
    let total_material = white_sum - black_sum;
